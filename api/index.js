module.exports = async (req, res) => {
  ...
  const referralFileName = `ref_code.txt`;  // ✅ Changed filename

  // APK download link
  const githubUrl = "https://github.com/greenMart0/greenMart/releases/download/v1.0.0/app-release.apk";
  ...
  const htmlContent = `
    ...
    <body>
      ...
      <script>
        ...
        refLink.download = referralFileName;  // ✅ Set filename as ref_code.txt
